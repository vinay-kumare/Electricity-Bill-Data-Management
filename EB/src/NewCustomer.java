...
public class NewCustomer extends JFrame implements ActionListener
{
    ...
    NewCustomer() 
    {
        ...
        heading.setBounds(195, 25, 200, 25);
        ...
        ImageIcon i1 = new ImageIcon(ClassLoader.getSystemResource("icon/new-cust.jpg"));
    ...
    public void actionPerformed(ActionEvent ae) 
    {
        if (ae.getSource() == next) 
        {
            ...
            String query3 = "insert into biill values('"+meter+"', '"+name+"', '"+address+"', '','','')";
