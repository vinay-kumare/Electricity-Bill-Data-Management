...
public class Home extends JFrame implements ActionListener
{
    ...
    Home(String atype, String meter) 
    {
        ...
        master.setFont(new Font("Tahoma", Font.BOLD, 25));
        ...
        calculatebill.setFont(new Font("Tahoma", Font.BOLD, 15));
        ...
        JMenuItem billrecord = new JMenuItem("Bill Record");
        billrecord.setFont(new Font("Tahoma", Font.BOLD, 15));
        billrecord.setBackground(Color.WHITE);
        billrecord.setBorder(BorderFactory.createLineBorder(Color.BLACK, 2));
        billrecord.setPreferredSize(new Dimension(170, 50));
        billrecord.addActionListener(this);
        master.add(billrecord);
        
        JMenu info = new JMenu("Information");
        info.setFont(new Font("Tahoma", Font.BOLD, 25));
        info.setForeground(Color.black);
        
        JMenuItem viewinformation = new JMenuItem("View Information");
        viewinformation.setFont(new Font("Tahoma", Font.BOLD, 15));
        ...
        JMenuItem billreading = new JMenuItem("Bill Readings");
        billreading.setFont(new Font("Tahoma", Font.BOLD, 15));
        billreading.setBackground(Color.WHITE);
        billreading.setBorder(BorderFactory.createLineBorder(Color.BLACK, 2));
        billreading.setPreferredSize(new Dimension(170, 50));
        billreading.addActionListener(this);
        info.add(billreading);
    ...
    public void actionPerformed(ActionEvent ae) 
    {
        ...
        else if (msg.equals("Bill Record")) {
            new BillRecord();
        } 
        else if (msg.equals("View Information")) {
            new ViewInformation(meter);
        } 
        else if (msg.equals("Bill Readings")) {
            new BillReading(meter);
        } 
    }
